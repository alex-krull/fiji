...
public abstract class Controller<T extends Trackable, IT extends  NumericType<IT> & NativeType<IT> & RealType<IT>  > implements MouseMotionListener,MouseListener, ImageListener {
	...
	protected Model<T,IT> controler;
	...
	protected Controller(ImagePlus imp, RandomAccessibleInterval<IT> img, Model<T,IT> contr){
