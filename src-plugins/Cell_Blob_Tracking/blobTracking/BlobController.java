...
public BlobController(ImagePlus imp, RandomAccessibleInterval<IT> img, Model<Blob,IT> contr){
    ...
    model.addTrackable(new Blob(0,i,20,20+ Math.sin(i/15.0f)*5,15,4));
    model.addTrackable(new Blob(1,i,70,20+ Math.sin(i/45.0f)*5,15,4));
    model.addTrackable(new Blob(2,i,20,70+ Math.sin(i/35.0f)*5,15,4));
