...
import frameWork.TrackingStrategy;

public class BlobTrackingStrategy <IT extends  NumericType<IT> & NativeType<IT> & RealType<IT> >extends TrackingStrategy <Blob,IT>{
	...
	@Override
	public synchronized void optimizeFrame(TrackingFrame <Blob, IT> tf) {
		MovieFrame<IT> movieFrame= tf.;
